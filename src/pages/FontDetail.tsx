...
import { FontFamily, getFont as supabaseGetFont, generateCSSImport, generateCSSLink, generateFontFaceCSS, getCSSUrl } from '@/lib/fontDB';
import { getFont as localGetFont } from '@/lib/localFontDB';
import { isLocalMode } from '@/lib/supabase';

const getFont = isLocalMode ? localGetFont : supabaseGetFont;
